...
score_for_functional_pipelined_mult2 = 0.25
score_for_functional_pipelined_mult3 = 0.25
score_for_functional_pipelined_mult4 = 0.25
score_for_advanced_pipelined_mult4 = 0.25
...
if scoreboard[5]:
    ...
    if scoreboard[5] <= 1636:
        _score_3 += score_for_advanced_pipelined_mult4
else:
    _score_3 = 0.0

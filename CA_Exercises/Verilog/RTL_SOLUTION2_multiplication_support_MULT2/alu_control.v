...
module alu_control(
      input wire [6:0] func7,       // Mul Operation needs func7_0 instead of func7_5.
   ...
   // customized MUL operation ALU control
   parameter [3:0] MUL_OP        = 4'd9; 

   //The decoding of the instruction funtion field into the desired
   //alu operation can be found in Figure 4.12 of the Patterson Book,
   //section 4.4
   wire [4:0] function_field = {func7[0], func7[5], func3};  // another bit (func7_0) is needed to identify mul op.
   ...
   parameter [4:0] FUNC_MUL      = 5'b10000;   // mul operation: funct7 = 0x01, funct3 = 0x0.

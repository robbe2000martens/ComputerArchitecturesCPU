...
assign reg_rs2_ID_EX = (instruction_opcode_ID_EX == ALU_I || instruction_opcode_ID_EX == LOAD )? 5'b0 : reg_rt_ID_EX; // I-Type does not have rt(rs2), use the static x0 instead.
...
module hazard_control_unit(
      ...
      input wire [2:0] instruction_func3_IF_ID,
      input wire reg_rs_equal_flag,
...
// RISC-V func3[2:0] (see RISC-V greensheet)
parameter integer B_BEQ = 3'b000;
...
// BRANCH begin
wire branch_valid;
assign branch_valid = (instruction_opcode_IF_ID == BRANCH);
always@(*) begin
   case(instruction_func3_IF_ID)
      B_BEQ: branch_taken = branch_valid & reg_rs_equal_flag; // beq
